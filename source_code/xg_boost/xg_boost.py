...
def xgb_train_model(train_dataset_path,train_hyperparameters):
    ...
    model_dir = os.path.join(train_hyperparameters.get('model_dir'),'xg_boost',test_case)
    os.makedirs(model_dir, exist_ok = True)
    params = {'learning_rate': train_hyperparameters.get('learning_rate'),
              'max_depth': train_hyperparameters.get('max_depth'), 
              'n_estimators':train_hyperparameters.get('n_estimators'),
              'subsample':train_hyperparameters.get('subsample'),
              'objective':train_hyperparameters.get('objective')}
...
def xgb_predict_model(dataset_path, model_path,k_value):
